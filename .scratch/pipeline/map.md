...
- [11 Historical static GTFS for the backfill window](issues/11-historical-static-gtfs.md) — resolved 2026-08-16: Transitland v2 holds dated versions of all six MTA bus feeds continuously from 2016-02 (Brooklyn: 93 versions), API key needed (download tier corrected by 12); Mobility Database starts 2025-12, transitfeeds/Wayback is pre-2017 only. Schedule delay in the backfill is a choice, not a wall.
